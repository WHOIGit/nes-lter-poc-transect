...
```{r}
# add package ID
pkg_id <- 'knb-lter-nes.27.2'

make_eml(here(),
         dataset.title='Particulate organic carbon and nitrogen (POC and PON) from Northeast U.S. Shelf Long Term Ecological Research (NES-LTER) Transect cruises, ongoing since 2017',
